    ...
    public void create() throws Exception
    {
        if (!this.tableExist("web_sys_data"))
        {
            ...
            UTILS.DB.executeUpdate("CREATE TABLE web_sys_data(ID BIGINT AUTO_INCREMENT PRIMARY KEY, "
                                                             ...
                                                             +"new_acc_reward DOUBLE(9,4) NOT NULL DEFAULT '0', "
                                                             +"root_whitelist_ip VARCHAR(5000) NOT NULL DEFAULT '', "
                                                             +"cpu_1_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_2_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_3_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_4_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_5_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_6_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_7_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_8_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_9_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_10_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_11_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_12_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_13_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_14_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_15_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_16_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_17_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_18_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_19_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_20_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_21_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
                                                             +"cpu_22_power DOUBLE(20, 8) NOT NULL DEFAULT '0', "
